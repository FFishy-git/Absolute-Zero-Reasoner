...
OUTPUT_SEED_PATH=${OUTPUT_SEED_PATH:-data/olmo3_7b_seed_io.jsonl}
OUTPUT_ERROR_SEED_PATH=${OUTPUT_ERROR_SEED_PATH:-data/olmo3_7b_error_seed_io.jsonl}
OUTPUT_CODE_F_SEED_PATH=${OUTPUT_CODE_F_SEED_PATH:-data/olmo3_7b_code_f_seed_io.jsonl}
...
python -m absolute_zero_reasoner.main_azr_ppo \
    ...
    actor_rollout_ref.model.path=allenai/OLMo-3-7B-Instruct-SFT \
    ...
    actor_rollout_ref.model.pretrained_tokenizer=False \
    ...
    trainer.experiment_name='azr_olmo3_7b' \
